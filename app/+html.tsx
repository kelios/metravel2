...
export default function Root({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    <head>
      ...
      <script dangerouslySetInnerHTML={{ __html: `(function(){try{var p=window.location&&window.location.pathname;if(p!=='/'&&p!=='/index')return;var vw=window.innerWidth||0;if(!vw)return;var imgW=0;var imgH=0;var quality=75;if(vw>=1280){imgW=vw>=1480?500:480;imgH=vw>=1480?420:360}else if(vw>=770){imgW=Math.round(vw*0.45);imgH=340}else{imgW=Math.max(280,Math.min(vw-32,800));imgH=vw>=768?280:220;quality=72}var u='https://metravel.by/travel-image/544/conversions/26d572d144174803a61fe96f2d7aa142.webp?w='+imgW+'&h='+imgH+'&q='+quality+'&fit=contain';if(document.querySelector('link[rel="preload"][href="'+u+'"]'))return;var l=document.createElement('link');l.rel='preload';l.as='image';l.href=u;try{l.fetchPriority='high';l.setAttribute('fetchPriority','high')}catch(_){}document.head.appendChild(l)}catch(_){}})();` }} />
