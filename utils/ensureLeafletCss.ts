...
function getLeafletOverridesCSS(): string {
  return [
    ...
    '.leaflet-popup.metravel-place-popup .leaflet-popup-content-wrapper{border-radius:28px!important;background:transparent!important;border:0!important;box-shadow:none!important;max-height:min(720px,calc(100vh - 80px))!important;overflow:hidden!important}',
    '.leaflet-popup.metravel-place-popup .leaflet-popup-content{padding:0!important;max-width:min(var(--metravel-popup-content-max-width,352px),calc(100vw - 32px))!important;border-radius:28px!important;max-height:min(700px,calc(100vh - 96px))!important;overflow-y:auto!important;overflow-x:hidden!important}',
