...
| TR-DET-07,15 | — | — | — | — | Похожие путешествия / удаление через UI — отдельными кейсами не догнаны |
...
| TR-WIZ-10,11,12,14 | — | — | — | — | Прогресс-бар цвета / восстановление черновика / оффлайн / модерация-админ — отдельными кейсами не догнаны |
...
| Флоу | Статус | Детали |
|------|:------:|--------|
| **Экспорт в PDF** | ✅ | Из деталей (Share→PDF) — e2e (TC-028). Книга `/export` — auth-gated: «Войдите, чтобы собрать PDF-книгу» (замок + Войти/Открыть Поиск) — поведение корректное; полная сборка требует логина |
...
| **Прохождение квестов** | ✅ | `/quests`: «Приключения», дерево городов (Беларусь/Армения/Польша), «Показать на карте», карточка квеста (Легко·6 точек·60 мин). Прохождение auth-gated: «Войдите, чтобы начать квест»; видео квеста — e2e (quest-video) |
...
| UP-01,02 | — | — | — | — | userpoints отдельным спеком не догнан |
...
| HOME-02..10 | — | — | — | — | Отдельные секции главной (mood-rail/FAQ/CTA/weekend) UI-кейсами не догнаны |
