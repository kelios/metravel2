...
(`utils/seoText.js:63-74`) снимает служебную первую строку маршрута и
декоративные пиктограммы **до** обрезки, иначе украшения съедали бюджет.
Финальный клэмп считает длину **в HTML-экранированном виде**, потому что
`< > & "` разворачиваются в сущности.
