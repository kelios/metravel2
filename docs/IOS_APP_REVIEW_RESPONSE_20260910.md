...
| 3 | Первый запуск, доступ к функциям, рабочий reviewer demo | Защищённые поля ASC + физический вход в #1889 | Инструкция подготовлена; фактический demo-вход ещё не подтверждён |
