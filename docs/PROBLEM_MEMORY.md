...
- **Пробел:** причина не снята, снят только её сигнал. Пока у экрана три набора,
  ...
  `styles/travelDetailsHeroMediaStyles.ts` после `#1708` и `lazySectionReserved`
  в `styles/travelDetailsLayoutStyles.ts` после `#1711` остались в одном
...
- **Последняя проверка:** 2026-09-02; `#1711` закрыт, гейт зелёный на текущем
  дереве и без исключений.
