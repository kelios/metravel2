...
- **Инвариант:** SEO-мониторинг либо меряет реальную выборку, либо падает; пустой
  результат никогда не выглядит как зелёный отчёт.
...
- **Цепочка:** ежедневный прод-гейт выдачи `#1107`, ложно-зелёный монитор
  индексации `#1325`, молчаливая подача всего сайта `#1389`; структурный ответ на
  третий рецидив — `#1391`.
