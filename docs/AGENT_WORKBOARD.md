...
| TD-027 | Remove or prove dead `SwipeablePanel` web/native modules after PERF-014 | `map-expert` + `refactor-surgeon` | P3 | PERF-014 map-expert review found `SwipeablePanel.tsx/.web.tsx` have 0 importers; remove only if source scan + map browser checks prove no runtime use | Open |
