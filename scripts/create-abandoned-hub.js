...
const payload = {
    ...
    name: 'Заброшенные дворцы, усадьбы и замки Беларуси: 38 атмосферных мест с фото и координатами',
    ...
    companions: [],
    over_nights_stay: [],
    plus: 'Все 38 мест проверены лично — от дворца Четвертинских в Желудке и замка с призраками в Гольшанах до Горваттов в Наровле; никаких толп и касс, свои фото и координаты каждой точки.',
