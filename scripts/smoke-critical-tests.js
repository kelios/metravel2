const SMOKE_CRITICAL_TESTS = [
  ...
  '__tests__/scripts/install-git-hooks.test.ts',
  '__tests__/scripts/run-e2e-changed.test.ts',
  '__tests__/scripts/validate-e2e-changed-decision.test.ts',
  '__tests__/scripts/validator-output.test.ts',
  '__tests__/scripts/validator-error-codes.test.ts',
  '__tests__/scripts/run-app-contract-tests-if-needed.test.ts',
