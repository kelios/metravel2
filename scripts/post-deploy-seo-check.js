 ...
 *
 * `/quests/country/<alias>`: лендинг страны идёт в выдачу, только если его
 * собственный текст берёт общий порог глубины — объём и долю формулировок,
 * которых не повторяет другая страна (#1929); до этого порогом было «больше
 * одного города» (#1762). Замер по живому каталогу 15.09.2026: ни одна из 34
 * стран порога не берёт (112–270 слов при 300 и максимум 20,7% своей лексики
 * при 30%), поэтому все страновые адреса отдают `noindex, follow`, а 18 из них
