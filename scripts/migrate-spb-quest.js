#!/usr/bin/env node
/**
 * Миграция квеста (Санкт-Петербург) на прод.
...
const QUESTS = require('./spb-quest-data.js');

async function main() {
    console.log(`🚀 Миграция квеста (Санкт-Петербург) → ${API_BASE} (${isDryRun ? 'DRY RUN' : 'LIVE'})\n`);
