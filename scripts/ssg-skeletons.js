...
.ssg-travel-article .img-row-2,.ssg-travel-article .img-grid,.ssg-travel-article .img-jrow{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin:18px 0 22px}
.ssg-travel-article .img-row-2>p,.ssg-travel-article .img-grid>p,.ssg-travel-article .img-jrow>p{margin:0;min-width:0;aspect-ratio:16/9;overflow:hidden;background:${COLORS.light.bgSecondary};border-radius:12px}
.ssg-travel-article .img-row-2 img,.ssg-travel-article .img-grid img,.ssg-travel-article .img-jrow img{width:100%;height:100%;max-width:none}
.ssg-travel-article p>img:only-child{width:100%;aspect-ratio:16/9;background:${COLORS.light.bgSecondary}}
@media(max-width:420px){.ssg-travel-article .img-row-2,.ssg-travel-article .img-grid,.ssg-travel-article .img-jrow{grid-template-columns:minmax(0,1fr)}}
