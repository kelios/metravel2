...
const RELEVANT_CATEGORIES = [
  ...
  { name: 'schema', pattern: /^scripts\/collect-selective-decisions\.js$/ },
  { name: 'schema', pattern: /^scripts\/validate-selective-decisions\.js$/ },
  ...
  { name: 'tests', pattern: /^__tests__\/scripts\/collect-selective-decisions\.test\.ts$/ },
  { name: 'tests', pattern: /^__tests__\/scripts\/validate-selective-decisions\.test\.ts$/ },
