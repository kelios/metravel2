 ...
 * необязательная ссылка, её открывают не все (карточка лишь предлагает её после
 * первого отказа, `components/quests/questWizardStepCard.tsx`), а считать игрок
 * начинает по заданию. Ровно так и было устроено большинство шагов свипа #1718 —
 * граница лежала в подсказке, и до неё доходили не все.
 *
