...
function QuestsContentPanel({
    ...
    // Сетка живёт не всегда: режим карты, незагруженные данные и пустая выборка
    // снимают её с экрана, и сохранённая высота протухает. Пришедший в это время
    // layout скроллера сравнил бы вьюпорт с высотой ПРЕЖНЕЙ сетки и раскрыл окно
    // вслепую, поэтому пока сетки нет — нет и высоты.
