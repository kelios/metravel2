...
export const HEADER_NAV_ITEMS: HeaderNavItem[] = [
  ...
  { path: 'https://metravel.by/travels/akkaunty-v-instagram-o-puteshestviyah-po-belarusi', label: 'Travel-блогеры Беларуси', icon: 'instagram', priority: 'secondary', external: true },
];
