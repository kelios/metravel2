...
export const MODERN_MATTE_PALETTE = {
  ...
  brand: '#e8863a', // Матовый тёплый оранжевый
  brandDark: '#d67630',
  brandText: '#c06a28', // Для текста/ссылок на светлом фоне (WCAG AA ≥4.5:1)
  brandLight: '#fef5f0', // Очень светлый оттенок для фонов
  brandSoft: 'rgba(232, 134, 58, 0.08)', // Едва заметная подсветка
