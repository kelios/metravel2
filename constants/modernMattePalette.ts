...
export const MODERN_MATTE_PALETTE = {
  ...
  textTertiary: '#6f6f6f', // Серый для подписей — WCAG AA: 4.9:1 на #fdfcfb (у #767676 было 4.43:1)
  ...
  brandDark: '#e07020',
  brandText: '#a95000', // Тёмно-оранжевый для текста (WCAG AA на brand-soft поверхностях)
...
export const MODERN_MATTE_PALETTE_DARK = {
  ...
  textTertiary: '#989898', // Средний серый для подписей — ≥4.4:1 на surfaceElevated #323232 (у #888888 было 3.6:1)
  textMuted: '#b8b8b8', // Приглушенный светлый для вторичного
  textInverse: '#1a1a1a', // Темный текст на светлых фонах
  textOnPrimary: '#1a1a1a', // Тёмный текст: в dark акценты светлые (#8fb5a5/#f0a060), светлый текст на них ≈1.8:1
