...
const governanceScopePattern = /^(cli-runner-policy\.test\.ts|external-links-docs-policy-parity\.test\.ts|external-links-guard-script-contract\.test\.ts|temp-dir-policy\.test\.ts|test-quality-governance\.test\.ts|governance-canonical-command-location\.test\.ts|governance-commands-doc-link-parity\.test\.ts|governance-docs-minimal-command-surface\.test\.ts|governance-docs-parity\.test\.ts|governance-docs-set-contract\.test\.ts|governance-docs-set-filesystem-contract\.test\.ts|governance-rule-enforcement-parity\.test\.ts|governance-script-parity\.test\.ts|governance-verify-anchor-coupling\.test\.ts|governance-verify-docs-parity\.test\.ts|governance-verify-script-contract\.test\.ts|guard-no-direct-linking-openurl\.test\.ts|guard-no-direct-window-open\.test\.ts|guard-seo-cli-contract\.test\.ts|guard-text-row-sizing\.test\.ts|guard-touch-targets\.test\.ts|policy-(helpers-contract-matrix|message-format-governance(?:-patterns)?|test-utils)\.test\.ts|seo-cli-contract\.test\.ts|targeted-test-list-.*\.test\.ts)$/
