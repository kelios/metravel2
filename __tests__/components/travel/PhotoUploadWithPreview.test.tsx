...
describe('PhotoUploadWithPreview', () => {
    ...
    describe('Image Removal', () => {
        it('should remove image when remove button is clicked', async () => {
            ...
            // The gallery action stays available when an old image is present.
            expect(getByText('Выбрать из галереи')).toBeTruthy();
    ...
    describe('Disabled State', () => {
        ...
        it('should not show remove button when disabled', () => {
            ...
            // When disabled with oldImage, the gallery action remains visible but no remove button is shown.
            expect(getByText('Выбрать из галереи')).toBeTruthy();
