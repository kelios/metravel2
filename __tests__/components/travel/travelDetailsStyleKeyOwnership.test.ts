 ...
 *
 * Чего этот гейт не ловит по построению — ключа, объявленного один раз и не
 * читаемого никем: сравнение наборов между собой мёртвый ключ от живого не
 * отличает. Этот инвариант держит соседний
 * `travelDetailsStyleKeyReadership.test.ts` (#1713).
 */
