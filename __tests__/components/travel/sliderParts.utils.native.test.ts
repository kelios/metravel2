...
describe('sliderParts/utils buildUriNative (native)', () => {
  ...
  it('caps neighbour slide width below the active slide on a retina phone', () => {
    ...
    // 390×3 = 1170: обоих капит потолок 800.
    //
    // #1113: потолок активного слайда был 1024 — ширина, которой у прокси НЕТ, так что
    // на неё сервер молча отдавал оригинал, и главное фото статьи на Android всегда
    // приезжало несжатым (замер прода 2026-07-28: w=1024 → 132 344 B = исходник,
    // w=800 → 53 104 B). Единая ступень 800 вдобавок означает, что сосед после свайпа
