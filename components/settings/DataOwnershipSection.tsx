...
/**
 * Управление своими данными: экспорт архива, удаление переписки и авторских
 * путешествий, отзыв согласий. Сохранённые маршруты («Хочу поехать») сюда не
 * входят — их чистит свой экран. Встраивается в settings.tsx в секцию
...
export default function DataOwnershipSection() {
    ...
    return (
        <View style={styles.card}>
            ...
            {/*
              * Кнопка зовёт `DELETE /user/data/authored-content/`: ручка удаляет все
              ...
              * маршрутов, которые чистятся на экране «Хочу поехать».
              */}
            <Button
                variant="danger-outline"
                fullWidth
