...
function HomeHowItWorks() {
  ...
  const styles = useMemo(() => StyleSheet.create({
    container: {
      paddingVertical: isMobile ? 36 : 80,
      backgroundColor: colors.backgroundSecondary,
      ...Platform.select({
        web: {
          backgroundImage: `linear-gradient(180deg, ${colors.background} 0%, ${colors.backgroundSecondary} 40%, ${colors.backgroundSecondary} 100%)`,
        },
      }),
    },
    header: {
    ...
    title: {
      ...
      lineHeight: isMobile ? 30 : 52,
    },
    subtitle: {
      fontSize: isMobile ? 14 : 17,
      color: colors.textMuted,
      textAlign: 'center',
      lineHeight: isMobile ? 21 : 27,
      maxWidth: 460,
      letterSpacing: 0.1,
    },
    stepsContainer: {
