...
import { ProfileQuickActions, type ProfileQuickActionKey } from '@/components/profile/ProfileQuickActions';
import {
...
interface ProfileOverviewTabProps {
  ...
  onOpenCalendar: () => void;
  handleQuickAction: (key: ProfileQuickActionKey) => void;
}
