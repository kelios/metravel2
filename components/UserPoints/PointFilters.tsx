 ...
 * По горизонтали запаса нет: у крайнего чипа полоска рамки за рядом на native
 * мертва (выигрыш web-only), зато чипы не сдвигаются; зазор 8 = inset, рамки
 * соседей касаются видимого круга, но не заходят на него.
 */
