...
function RouteBuilder({
  ...
  // раскладке `mapFirst`: в `stack` строка точки получает `onFocus=undefined` и
  // карту не двигает. Токен растёт на каждый тап, поэтому повторный тап по той
  // же точке возвращает карту к ней даже после ручного панорамирования.
  ...
  // desktop, две колонки, шаги слева и карта справа; `mapFirst` — её собирает
