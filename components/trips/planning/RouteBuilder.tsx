...
function RouteBuilder({
  ...
  // #1495: тап по точке в списке панели центрует карту на этой точке. Токен
  ...
  // стеком (desktop и вся историческая раскладка) или раскладкой `mapFirst`,
  // которую собирает RouteBuilderMobile — карта блоком, панель обычным контентом
  // под ней (#1495 завёл mobile-раскладку шторкой, #1691 заменил её на этот
  // блок). Разъезжаться содержимому между раскладками нельзя.
  //
