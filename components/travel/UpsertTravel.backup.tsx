    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                // Since API returns arrays directly in root, prefer filtersObj over nested fallbacks
                const filtersResolved: any = filtersObj;
                ...
                const normalizedCountries = normalizeCountries(filtersData?.countries || []);
...
function transformTravelToFormData(travel: Travel): TravelFormData {
    ...
    return {
        ...
        // Нормализуем все массивы к строковым массивам ID
