...
export const createContentUpsertStyles = (colors: Colors) => StyleSheet.create({
    ...
    descriptionAdvancedButtonText: {
        fontSize: DESIGN_TOKENS.typography.sizes.sm,
        fontWeight: '700',
        color: colors.primaryText,
    },
    // Ряд инструментов описания рисует ui/ToolActionsRow: здесь только внешние отступы.
    descriptionActionsRow: { marginTop: DESIGN_TOKENS.spacing.sm, marginBottom: DESIGN_TOKENS.spacing.xs },
