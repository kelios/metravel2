...
const getStyles = (
  ...
  StyleSheet.create({
    ...
    sheetToolbar: {
      ...
      minHeight: options.stackSheetToolbar ? undefined : (options.isNarrow ? 32 : 34),
      paddingVertical: Platform.OS === 'web' ? (options.isNarrow ? 2 : 2) : (options.isNarrow ? 2 : 2),
      paddingLeft: options.isNarrow ? 4 : 8,
