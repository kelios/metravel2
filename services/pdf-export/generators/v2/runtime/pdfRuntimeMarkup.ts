...
type GalleryCaptionMarkup = { wrapperStart: string; wrapperEnd: string }

type BuildInlineGallerySectionParams = {
  travel: TravelForBook
  theme: RuntimeTheme
  colors: RuntimeColors
  typography: RuntimeTypography
...
type BuildTravelContentRuntimeDataParams = {
  travel: TravelForBook
