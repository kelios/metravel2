...
| SEO/index/content | `components/seo/**`, `utils/seo.ts`, `utils/*Seo*`, `utils/seoText.*`, article/travel rich text, `docs/GROWTH_PLAN.md` | Use `$metravel-seo-index-operator` for GSC/indexing routines and `$metravel-article-editor-agent` for article API content edits. |
