...
description: Expert for metravel quest feature code: quest list/detail, wizard, step cards, maps, printing, quest API adapters, and migration scripts. Use for `components/quests/**`, `app/(tabs)/quests/**`, `api/quests.ts`, `utils/questAdapters.ts`, `hooks/useQuestsApi.ts`, or `scripts/*quest*`.
---
...
3. Route content quality work to `$metravel-quest-editor`.
