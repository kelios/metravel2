...
// Until #1823 its `metravel-*` entries were hand-maintained snapshots that lagged `.codex/skills`
// silently, so only metadata was enforced here. They are now generated by
// `npm run sync:copilot-skills`, so text drift is an audit failure like any other mirror.
// `speckit-*` stays vendor-owned (spec-kit manifest) and is skipped by the vendor predicate.
const copilotSkills = auditSkillFamily(copilotSkillsRoot, skillsRoot, '.codex/skills')
