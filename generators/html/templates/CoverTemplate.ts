...
export function generateCoverTemplate(data: CoverTemplateData): string {
  ...
  const backgroundStyle = coverImage
    ...
    : 'linear-gradient(135deg, rgb(255,159,90) 0%, rgb(255,107,53) 50%, rgb(255,140,66) 100%)';
  ...
  return `
    ...
    ">
      <div style="padding: 40mm 30mm; width: 100%; position: relative; z-index: 2;">
        ${subtitle ? `
          <div style="font-size: 14pt; font-weight: 500; letter-spacing: 0.2em; text-transform: uppercase; margin-bottom: 15mm; opacity: 0.9; color: rgb(255,210,143);">
            ${escapeHtml(subtitle)}
          </div>
        ` : ''}
        ...
        <div style="width: 80mm; height: 3px; background-color: rgb(255,159,90); margin: 0 auto 20mm; border-radius: 2px; box-shadow: 0 2px 10px rgba(255,159,90,0.5);"></div>
        ...
        <div style="display: flex; justify-content: center; gap: 20mm; margin-top: 30mm; font-size: 16pt; font-weight: 600;">
          ...
          ${yearRange ? `
            <div style="border-left: 1px solid rgba(255,255,255,0.3); padding-left: 20mm;">
              <div style="font-size: 32pt; font-weight: 800; color: rgb(255,159,90); margin-bottom: 3mm;">${escapeHtml(yearRange)}</div>
