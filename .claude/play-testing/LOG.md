...
| 14   | 2026-07-22 | ⚠️          | snapshot refreshed: `com.baremacros.app` 1→10, `com.kitchenmatch.game` 3→6, `com.kolorino.kolorino` 6→7, `com.ja.callofpoker` 69000→71000 | Pack Boneclaw IV: direct 3+ minute testing done for 10/11 assigned apps; TC mission UI still `0/11 done`; TCT: one partner MeTravel proof accepted; App Testers/NadeemGS TC inspected | Evidence: `.claude/play-testing/evidence/2026-07-22/`; blocker: Kolorino foreground escaped to another app/system picker during coloring; no crash-buffer hits |
