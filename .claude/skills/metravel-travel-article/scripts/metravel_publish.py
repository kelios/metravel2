...
COUNTRY = {"Польша":160,"Словакия":184,"Чехия":215,"Австрия":20,"Беларусь":3,
           "Испания":87,"Португалия":161,"Хорватия":212}
...
def md_to_html(body):
    ...
    for raw in body.splitlines():
        ...
        if line.startswith("## "): fp(); fl(); out.append("<h2>"+line[3:].strip()+"</h2>"); continue
        if line.startswith("### "): fp(); fl(); out.append("<h3>"+line[4:].strip()+"</h3>"); continue
