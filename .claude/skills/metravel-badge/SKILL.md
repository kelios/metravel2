---
name: metravel-badge
description: "Добавление/обновление значка достижений: визуал, AI-промпт картинки, mock-каталог и тикет на BE-seed. Триггеры: «добавь значок», «новый бейдж за <действие>», «сгенерируй картинку значка»."
---
