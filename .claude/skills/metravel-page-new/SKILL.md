...
description: "Создание новой страницы/лендинга: роут Expo Router, секции, компоненты дизайн-системы, SEO-мета и браузер-проверка. Триггеры: «сделай новую страницу <X>», «лендинг для <фичи>», «добавь экран с нуля»."
---
...
работой прочитай `CLAUDE.md`, `docs/RULES.md`, `docs/DESIGN_SYSTEM.md`.
