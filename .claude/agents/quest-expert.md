...
name: quest-expert
description: >-
  Код фичи quests: `components/quests/**`, `app/(tabs)/quests/**`, `api/quests.ts`,
  `utils/questAdapters.ts`, `hooks/useQuestsApi.ts`, `scripts/*quest*` — список, деталь,
  прохождение, печать, данные и миграции.
